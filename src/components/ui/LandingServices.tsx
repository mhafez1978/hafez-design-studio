    ...
    <section>
      <div className="w-screen min-h-screen flex flex-col pt-6 justify-start items-center">
        <div className="w-full flex flex-col items-center py-20">
          <h3 className="text-4xl font-black mb-4 italic">
            Our Design Approach
          </h3>
          ...
          <p className="w-[40%] mx-auto text-center text-lg mb-8">
            We blend global experience and design expertise,{" "}
            <span className="font-black">Hafez Design Studio</span> creates
            timeless, sophisticated spaces that reflect your unique modern
            style.
          </p>
        </div>
