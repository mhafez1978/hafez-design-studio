    ...
    <>
      <section className="w-screen pt-[180px] mb-[200px]">
        <div className="container mx-auto h-[65vh] overflow-hidden mb-12">
          <img
            src="/kitchen-reno-east-view.png"
        ...
        <div className="container mx-auto">
          <div className="w-full flex flex-row mb-8">
            <div className="w-1/2">
              <h1 className="text-3xl font-black">Kitchen Renovation</h1>
            ...
            <div className="w-1/2">
              <div className="w-full flex flex-col">
                <img
                  src="/kitchen-reno-west-view.png"
          ...
          <div className="w-full h-[500px] flex flex-row gap-6">
            <div className="w-1/2 h-[800px]">
              <img
                src="/kitchen-reno-north-east-view.png"
            ...
            <div className="w-1/2 h-[800px]">
              <img
                src="/kitchen-reno-north-west-view.png"
                alt="kitchen-reno-north-view"
                className="object-cover  w-full h-[50%]"
                width={800}
                height={450}
